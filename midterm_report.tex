...
クラウドコンピューティング導入の動きは，教育機関においても例外ではない．
文部科学省の情報基盤実態調査によると，平成28年度における日本の大学の全体の80.6\%が情報システムをクラウドしている\cite{SurveyOnActualStateOfAcademicInformationInfrastructure}．
また，近年のICT教育の現場では，実践的な演習活動を行うようになってきており，
